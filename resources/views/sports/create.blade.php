...
--}}
    ...
    <form action="{{route('taches.store')}}" method="POST">
        ...
        <div>
            ...
            <input type="date" name="expiration" id="expiration" value="{{ old('expiration') }}" placeholder="aaaa-mm-jj">
        </div>
        <div>
            {{-- la catégorie --}}
        ...
        <div>
            <label for="effectuee"><strong>Accomplie ?</strong></label>
            @if(old('effectuee') !== NULL && (old('effectuee') == 'O' || old('accomplie') == 'on'))
            <input type="checkbox" name="effectuee" checked id="accomplie">
            @else
